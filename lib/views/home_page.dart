...
import 'package:jaishree/views/experience_section.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  final GlobalKey _experienceKey = GlobalKey(); // Add _experienceKey
    ...
    return Scaffold(
      ...
      drawer: isMobile
          ? buildMobileDrawer(
              ...
              scrollToContact: () => _scrollToSection(_experienceKey),
            )
          : null,
          ...
          builder: (context, constraints) {
            return Container(
              constraints: BoxConstraints(
                minWidth: ResponsiveBuilder.mobileMaxWidth.toDouble(),
              ),
              child: Column(
                children: [
                  Padding(
